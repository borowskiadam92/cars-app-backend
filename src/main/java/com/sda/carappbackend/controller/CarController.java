...
public class CarController {
    ...
    @PostMapping
    public ResponseEntity <Car> createCar(@RequestBody  CreateCarDto newCar){
    ...
    public ResponseEntity <Car> findCarById(@PathVariable Long id){
        Car carById = serviceCars.findCarById(id);
        return new ResponseEntity<>(carById,HttpStatus.ACCEPTED);
